...
foreach ($version in @('2.12.2','2.12.2.0','2.13.0','2.13.0.0','2.14.0','2.14.0.0')) {
    Assert-AntigravityVersion $version
    Write-Host "PASS: Supported version $version"
}
foreach ($version in @('2.12.20.0','2.13.1.0','2.13.0.1','2.14.1.0','2.14.0.1','2.140.0','3.0.0','invalid')) {
    $failure=$null
